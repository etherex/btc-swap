...
function toWords(input) {
	...
	} else if ((typeof input === "undefined" ? "undefined" : _typeof(input)) === _typeof("")) {
...
module.exports = {
	Keccak: Keccak,
	nibbleToChar: nibbleToChar,
	charToNibble: charToNibble,
